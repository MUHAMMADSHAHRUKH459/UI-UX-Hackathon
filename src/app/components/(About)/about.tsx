    ...
    <section className="text-gray-600 body-font py-12">
      <div className="container px-5 md:px-28 mx-auto flex flex-wrap md:flex-nowrap justify-center md:justify-between">
        ...
        <div className="w-full md:w-1/2 px-4 md:px-8 mb-6 md:mb-0 bg-teal-600 p-8 rounded-lg shadow-lg text-white flex flex-col justify-between items-center md:items-start">
          ...
          At Comforty, we are dedicated to crafting spaces that inspire and comfort. Our commitment to excellence combines innovation with sustainable practices, ensuring that every experience reflects our passion for quality and design. Whether through our products or services, we strive to create a meaningful impact, fostering connections and enhancing everyday living. Discover the perfect blend of style and functionality with Comforty.
          </p>
